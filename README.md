...
[![Version](https://img.shields.io/badge/version-1.1.4-1E3A8A.svg)](CHANGELOG.md)
...
|---|---|---|
| **macOS** — Apple Silicon (M1+) or Intel | [`modern8086_1.1.4_universal.dmg`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.4_universal.dmg) | One universal `.dmg` covers both Intel and Apple Silicon. |
| **Windows 10/11** — most users | [`modern8086_1.1.4_x64-setup.exe`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.4_x64-setup.exe) | NSIS installer; doesn't need admin rights (`installMode: currentUser`). |
| **Windows** — corporate / Group Policy | [`modern8086_1.1.4_x64_en-US.msi`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.4_x64_en-US.msi) | WiX MSI for IT-managed deployments. |
| **Linux** — Debian / Ubuntu / Mint | [`modern8086_1.1.4_amd64.deb`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.4_amd64.deb) | `sudo dpkg -i …` |
| **Linux** — any distro, no install | [`modern8086_1.1.4_amd64.AppImage`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.4_amd64.AppImage) | `chmod +x` and run; portable, no system changes. |
...
Universal signed APK — one file, runs on every Android device:

[`modern8086-android-1.1.4.apk`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.4.apk)

Enable "Install from unknown sources" in Settings, open the APK,
done. The matching [`modern8086-android-1.1.4.aab`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.4.aab)
is also attached for the Play Store path (listing in flight; see
