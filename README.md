...
[![Version](https://img.shields.io/badge/version-1.1.2-1E3A8A.svg)](CHANGELOG.md)
...
|---|---|---|
| **macOS** — Apple Silicon (M1+) or Intel | [`modern8086_1.1.2_universal.dmg`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.2_universal.dmg) | One universal `.dmg` covers both Intel and Apple Silicon. |
| **Windows 10/11** — most users | [`modern8086_1.1.2_x64-setup.exe`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.2_x64-setup.exe) | NSIS installer; doesn't need admin rights (`installMode: currentUser`). |
| **Windows** — corporate / Group Policy | [`modern8086_1.1.2_x64_en-US.msi`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.2_x64_en-US.msi) | WiX MSI for IT-managed deployments. |
| **Linux** — Debian / Ubuntu / Mint | [`modern8086_1.1.2_amd64.deb`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.2_amd64.deb) | `sudo dpkg -i …` |
| **Linux** — any distro, no install | [`modern8086_1.1.2_amd64.AppImage`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086_1.1.2_amd64.AppImage) | `chmod +x` and run; portable, no system changes. |
...
|---|---|---|
| **Modern phones** (Pixel, Galaxy S/A, OnePlus, Xiaomi — anything 2019+) | [`modern8086-android-1.1.2-arm64-v8a.apk`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.2-arm64-v8a.apk) | Default pick. 95% of Android phones in use today. |
| **Older 32-bit phones** (pre-2019, budget devices) | [`modern8086-android-1.1.2-armeabi-v7a.apk`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.2-armeabi-v7a.apk) | Use only if `arm64-v8a` says "incompatible". |
| **Android emulators** (BlueStacks, Genymotion, x86 images) | [`modern8086-android-1.1.2-x86_64.apk`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.2-x86_64.apk) | x86_64 emulator images. |
| **Very old x86 emulators** | [`modern8086-android-1.1.2-x86.apk`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.2-x86.apk) | Rare; legacy 32-bit x86. |
| Play Store (when live) | [`modern8086-android-1.1.2.aab`](https://github.com/abuXsarkar/modern8086/releases/latest/download/modern8086-android-1.1.2.aab) | Not for sideload — Play Console only. |
