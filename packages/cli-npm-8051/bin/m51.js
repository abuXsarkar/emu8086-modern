...
if (!existsSync(binary)) {
  console.error(
    "[m51] binary not found at " +
      ...
      "  • npm rebuild @modern8086/cli-8051\n" +
      "  • install manually from https://github.com/abuXsarkar/modern8086/releases\n" +
      "  • or build from source: cargo install --path packages/cli-8051",
  );
  process.exit(1);
}
...
if (result.error) {
  console.error("[m51] failed to launch:", result.error.message);
  process.exit(1);
}
