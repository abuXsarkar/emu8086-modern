/// Brand mark for modern8051 — same DIP-package construction as the
/// 8086 and 8085 marks (square outline, pin-1 notch top-left, four
/// corner pins, centred mnemonic). Differs in centred text: `0x51`.

export function Mark51({ size = 28 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <text
        ...
        fill="currentColor"
      >
        0<tspan fill="var(--accent)">x</tspan>51
      </text>
    </svg>
  );
}
