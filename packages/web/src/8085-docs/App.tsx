...
import { OPCODE_DOCS } from "../8085/asm8085_docs";
import { EXAMPLES } from "../8085/examples";
  ...
  return (
    <div className="docs-root">
      <header className="docs-header">
        <a href="/8085/" className="docs-brand">
          <span className="docs-brand-mark">modern</span>
          <span className="docs-brand-strong">8085</span>
      ...
      <main className="docs-main">
        <section className="docs-section">
          <h1 className="docs-h1">
            A 60-second tour of <em>modern8085</em>.
          </h1>
          <p className="docs-lede">
            Open the <a href="/8085/">IDE</a>, pick a program from <em>Examples ▾</em>, hit{" "}
        ...
        <Section title="Dialect">
          <p>
            Canonical Intel 8085 syntax: <code>;</code> comments to EOL, hex with the trailing{" "}
          ...
          <p>
            ...
            kind of thing you trip on when pasting from sim8085, GNUSim8085, OshonSoft, or a textbook PDF.
...
m85 run prog.a85 \\
  ...
  --mem-dump 3050,16`}</pre>
        ...
        <Section title="Why this exists">
          <p>
            Existing 8085 tools have one or more of: install hell (Windows-only, Java-required, broken on
            M1 Macs), 1998-era UI, infinite loops that freeze the whole app, no share-via-URL, no examples
            bundled, no inline mnemonic docs. modern8085 fixes all of those.
          </p>
          <p>
            Sibling tool to <a href="https://modern8086.com">modern8086</a>. Same chassis, same brand,
            same MIT license; distinct ISA because the 8085 is genuinely a different architecture.
          </p>
        </Section>
      </main>
