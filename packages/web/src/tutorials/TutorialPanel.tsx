// Slide-in tutorials drawer. Mirrors the classroom drawer in shape
// — slim strip on the right edge until the user opens it. Two modes:
//
//   1. Picker: 10 lesson cards with progress indicator + estimated
//      minutes.
//   2. Active lesson: step-by-step navigation, "Load this code"
//      affordance, completion state.
//
// The "load this code" callback is provided by App.tsx so the
// drawer doesn't need to know about the editor's internals.
