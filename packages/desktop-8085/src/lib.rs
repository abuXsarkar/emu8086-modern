// Tauri desktop + mobile entry for modern8085. Mirror of
...
#[cfg(desktop)]
const DOCS_URL: &str = "https://modern8086.com/8085/docs/";
#[cfg(desktop)]
...
fn build_menu<R: tauri::Runtime>(app: &tauri::AppHandle<R>) -> tauri::Result<tauri::menu::Menu<R>> {
    ...
    let app_submenu = SubmenuBuilder::new(app, "modern8085")
